                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (p_expression->expression_type == 39)
                                    {
                                        struct flow_object * p_obj;
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        if (p_expression->expression_type == 60)
                                                        {
                                                            struct flow_object * p_obj;
                                                        ...
                                                        {
                                                            if (p_expression->expression_type == 72)
                                                            {
                                                                struct flow_object * p_object;
                                                            ...
                                                            {
                                                                if (p_expression->expression_type == 53 || p_expression->expression_type == 54)
                                                                {
                                                                    struct flow_object * p_object;
                                                                ...
                                                                {
                                                                    if (p_expression->expression_type == 45)
                                                                    {
                                                                        struct flow_object * p_object;
                                                                    ...
                                                                    {
                                                                        if (p_expression->expression_type == 37 || p_expression->expression_type == 38)
                                                                        {
...

        {
            ...
            _CKL92: /*case 50*/ 
            {
                ...
                if (left_is_constant)
                {
                    ...
                    if (left_value == 0)
                    {
                        ...
                        if (p_expression->expression_type == 51 || p_expression->expression_type == 52)
                        {
                            true_false_set_invert(expr_true_false_set);
                        }
                    }
            ...
            _CKL100: /*case 53*/ 
            {
                ...
                if (p_comp_expression)
                {
                    ...
                    if (p_expression->expression_type == 53 && value == 0)
                    {
                        true_false_set_invert(expr_true_false_set);
                    }
                    else
