...
static void register_struct_types_and_functions(struct d_visit_ctx * ctx, struct type * p_type0)
{
    if (1) /*try*/
    {
        ...
        while (p_type)
        {
            /*switch*/
            {
                register int __Ck0_temp = p_type->category;
                if (__Ck0_temp == 0) goto _CKL2; /*case 0*/
                if (__Ck0_temp == 1) goto _CKL24; /*case 1*/
                if (__Ck0_temp == 2) goto _CKL25; /*case 2*/
                if (__Ck0_temp == 3) goto _CKL26; /*case 3*/
                goto _CKL1;
                            ...
                            if (p_complete)
                            {
                                ...
                                if (p == 0U)
                                {
                                    ...
                                    if (p_name != 0U)
                                    {
                                        ...
                                        snprintf(new_name, 100U, "%s%d", p_complete->tag_name, ctx->cake_tag_count++);
...
static void d_print_type_core(struct d_visit_ctx * ctx, struct osstream * ss, struct type * p_type0, char * name_opt)
{
    ...
    while (p_type)
    {
        /*switch*/
        {
            register int __Ck2_temp = p_type->category;
            if (__Ck2_temp == 0) goto _CKL1; /*case 0*/
            if (__Ck2_temp == 2) goto _CKL16; /*case 2*/
            if (__Ck2_temp == 1) goto _CKL20; /*case 1*/
            if (__Ck2_temp == 3) goto _CKL28; /*case 3*/
            goto _CKL0;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (p_type->type_specifier_flags & 512)
                            {
                                /*switch*/
                                {
                                    register int __Ck3_temp = ctx->options.target;
                                    if (__Ck3_temp == 0) goto _CKL7; /*case 0*/
                                    if (__Ck3_temp == 1) goto _CKL8; /*case 1*/
                                    if (__Ck3_temp == 2) goto _CKL9; /*case 2*/
                                    if (__Ck3_temp == 3) goto _CKL10; /*case 3*/
                                    if (__Ck3_temp == 4) goto _CKL11; /*case 4*/
                                    goto _CKL6;
...
static void d_print_type(struct d_visit_ctx * ctx, struct osstream * ss, struct type * p_type, char * name_opt)
{
    ...
    if (p_type->storage_class_specifier_flags & 8)
    {
        /*switch*/
        {
            register int __Ck4_temp = ctx->options.target;
            if (__Ck4_temp == 1) goto _CKL4; /*case 1*/
            if (__Ck4_temp == 2) goto _CKL5; /*case 2*/
            if (__Ck4_temp == 0) goto _CKL6; /*case 0*/
            if (__Ck4_temp == 3) goto _CKL7; /*case 3*/
            if (__Ck4_temp == 4) goto _CKL8; /*case 4*/
            goto _CKL3;
...
void d_visit(struct d_visit_ctx * ctx, struct osstream * oss)
{
    ...
    ss_fprintf(oss, "// Cake %s target=%s\n", "0.12.05", target_to_string(ctx->options.target));
    ctx->indentation = 0;
...
static void d_visit_label(struct d_visit_ctx * ctx, struct osstream * oss, struct label * p_label)
{
    if (p_label->p_first_token->type == 9002)
    {
        char str[50];
    ...
    else
    {
        ...
        {
            if (p_label->p_first_token->type == 9008)
            {
                print_identation(ctx, oss);
...
static void d_visit_iteration_statement(struct d_visit_ctx * ctx, struct osstream * oss, struct iteration_statement * p_iteration_statement)
{
    ...
    print_identation(ctx, oss);
    if (p_iteration_statement->first_token->type == 9043)
    {
    ...
    {
        if (p_iteration_statement->first_token->type == 9009)
        {
            ss_fprintf(oss, "do\n");
            d_visit_secondary_block(ctx, oss, p_iteration_statement->secondary_block);
            print_identation(ctx, oss);
        ...
        {
            if (p_iteration_statement->first_token->type == 9016)
            {
...
static void d_visit_selection_statement(struct d_visit_ctx * ctx, struct osstream * oss, struct selection_statement * p_selection_statement)
{
    ...
    if (p_selection_statement->first_token->type == 9035)
    {
        ...
        ctx->indentation++;
        _cake_zmem(&name, 100);
        snprintf(name, 100U, "__Ck%d_temp", ctx->cake_declarator_number++);
        print_identation(ctx, &ss);
...
static void expression_to_bool_value(struct d_visit_ctx * ctx, struct osstream * oss, struct expression * p_expression)
{
    ...
    else
    {
        ...
        else
        {
            /*switch*/
            {
                register int __Ck6_temp = p_expression->expression_type;
                if (__Ck6_temp == 53) goto _CKL4; /*case 53*/
                if (__Ck6_temp == 54) goto _CKL5; /*case 54*/
                if (__Ck6_temp == 55) goto _CKL6; /*case 55*/
                if (__Ck6_temp == 56) goto _CKL7; /*case 56*/
                if (__Ck6_temp == 57) goto _CKL8; /*case 57*/
                if (__Ck6_temp == 58) goto _CKL9; /*case 58*/
                if (__Ck6_temp == 59) goto _CKL10; /*case 59*/
                if (__Ck6_temp == 60) goto _CKL11; /*case 60*/
                if (__Ck6_temp == 61) goto _CKL12; /*case 61*/
                if (__Ck6_temp == 62) goto _CKL13; /*case 62*/
                if (__Ck6_temp == 63) goto _CKL14; /*case 63*/
                if (__Ck6_temp == 64) goto _CKL15; /*case 64*/
                if (__Ck6_temp == 65) goto _CKL16; /*case 65*/
                if (__Ck6_temp == 66) goto _CKL17; /*case 66*/
                if (__Ck6_temp == 67) goto _CKL18; /*case 67*/
                if (__Ck6_temp == 68) goto _CKL19; /*case 68*/
                if (__Ck6_temp == 69) goto _CKL20; /*case 69*/
                if (__Ck6_temp == 70) goto _CKL21; /*case 70*/
                if (__Ck6_temp == 71) goto _CKL22; /*case 71*/
                if (__Ck6_temp == 72) goto _CKL23; /*case 72*/
                goto _CKL24;/*default*/
    ...
    else
    {
        if (p_jump_statement->first_token->type == 9028)
        {
            ...
            else
            {
                ...
                _cake_zmem(&name, 100);
                snprintf(name, 100U, "__Ck%d_tmp", ctx->cake_declarator_number++);
                print_identation(ctx, oss);
        ...
        {
            if (p_jump_statement->first_token->type == 9001 || p_jump_statement->first_token->type == 9006)
            {
                il_print_defer_list(ctx, oss, &p_jump_statement->defer_list);
                print_identation(ctx, oss);
...
static void d_visit_function_body(struct d_visit_ctx * ctx, struct osstream * oss, struct declarator * function_definition)
{
    ...
    if (function_definition->function_body == 0U)
    {
        ;
        return;
    }
...
static char *get_op_by_expression_type(int type)
{
    /*switch*/
    {
        register int __Ck7_temp = type;
        if (__Ck7_temp == 60) goto _CKL1; /*case 60*/
        if (__Ck7_temp == 61) goto _CKL2; /*case 61*/
        if (__Ck7_temp == 62) goto _CKL3; /*case 62*/
        if (__Ck7_temp == 63) goto _CKL4; /*case 63*/
        if (__Ck7_temp == 64) goto _CKL5; /*case 64*/
        if (__Ck7_temp == 65) goto _CKL6; /*case 65*/
        if (__Ck7_temp == 66) goto _CKL7; /*case 66*/
        if (__Ck7_temp == 67) goto _CKL8; /*case 67*/
        if (__Ck7_temp == 68) goto _CKL9; /*case 68*/
        if (__Ck7_temp == 69) goto _CKL10; /*case 69*/
        if (__Ck7_temp == 70) goto _CKL11; /*case 70*/
        goto _CKL12;/*default*/
...
static void d_visit_expression(struct d_visit_ctx * ctx, struct osstream * oss, struct expression * p_expression)
{
    ...
    /*switch*/
    {
        register int __Ck5_temp = p_expression->expression_type;
        if (__Ck5_temp == 0) goto _CKL5; /*case 0*/
        if (__Ck5_temp == 4) goto _CKL6; /*case 4*/
        if (__Ck5_temp == 2) goto _CKL9; /*case 2*/
        if (__Ck5_temp == 3) goto _CKL20; /*case 3*/
        if (__Ck5_temp == 1) goto _CKL21; /*case 1*/
        if (__Ck5_temp == 5) goto _CKL22; /*case 5*/
        if (__Ck5_temp == 8) goto _CKL23; /*case 8*/
        if (__Ck5_temp == 6) goto _CKL24; /*case 6*/
        if (__Ck5_temp == 9) goto _CKL25; /*case 9*/
        if (__Ck5_temp == 7) goto _CKL26; /*case 7*/
        if (__Ck5_temp == 25) goto _CKL28; /*case 25*/
        if (__Ck5_temp == 21) goto _CKL30; /*case 21*/
        if (__Ck5_temp == 22) goto _CKL32; /*case 22*/
        if (__Ck5_temp == 23) goto _CKL33; /*case 23*/
        if (__Ck5_temp == 24) goto _CKL34; /*case 24*/
        if (__Ck5_temp == 14) goto _CKL36; /*case 14*/
        if (__Ck5_temp == 15) goto _CKL38; /*case 15*/
        if (__Ck5_temp == 16) goto _CKL40; /*case 16*/
        if (__Ck5_temp == 17) goto _CKL41; /*case 17*/
        if (__Ck5_temp == 13) goto _CKL42; /*case 13*/
        if (__Ck5_temp == 12) goto _CKL43; /*case 12*/
        if (__Ck5_temp == 40) goto _CKL47; /*case 40*/
        if (__Ck5_temp == 10) goto _CKL48; /*case 10*/
        if (__Ck5_temp == 11) goto _CKL50; /*case 11*/
        if (__Ck5_temp == 18) goto _CKL52; /*case 18*/
        if (__Ck5_temp == 19) goto _CKL53; /*case 19*/
        if (__Ck5_temp == 30) goto _CKL54; /*case 30*/
        if (__Ck5_temp == 29) goto _CKL55; /*case 29*/
        if (__Ck5_temp == 20) goto _CKL56; /*case 20*/
        if (__Ck5_temp == 32) goto _CKL57; /*case 32*/
        if (__Ck5_temp == 33) goto _CKL58; /*case 33*/
        if (__Ck5_temp == 34) goto _CKL59; /*case 34*/
        if (__Ck5_temp == 35) goto _CKL60; /*case 35*/
        if (__Ck5_temp == 36) goto _CKL61; /*case 36*/
        if (__Ck5_temp == 37) goto _CKL62; /*case 37*/
        if (__Ck5_temp == 38) goto _CKL63; /*case 38*/
        if (__Ck5_temp == 39) goto _CKL64; /*case 39*/
        if (__Ck5_temp == 31) goto _CKL65; /*case 31*/
        if (__Ck5_temp == 46) goto _CKL66; /*case 46*/
        if (__Ck5_temp == 45) goto _CKL67; /*case 45*/
        if (__Ck5_temp == 42) goto _CKL68; /*case 42*/
        if (__Ck5_temp == 43) goto _CKL69; /*case 43*/
        if (__Ck5_temp == 44) goto _CKL70; /*case 44*/
        if (__Ck5_temp == 71) goto _CKL71; /*case 71*/
        if (__Ck5_temp == 60) goto _CKL72; /*case 60*/
        if (__Ck5_temp == 61) goto _CKL74; /*case 61*/
        if (__Ck5_temp == 62) goto _CKL75; /*case 62*/
        if (__Ck5_temp == 63) goto _CKL76; /*case 63*/
        if (__Ck5_temp == 64) goto _CKL77; /*case 64*/
        if (__Ck5_temp == 65) goto _CKL78; /*case 65*/
        if (__Ck5_temp == 66) goto _CKL79; /*case 66*/
        if (__Ck5_temp == 67) goto _CKL80; /*case 67*/
        if (__Ck5_temp == 68) goto _CKL81; /*case 68*/
        if (__Ck5_temp == 69) goto _CKL82; /*case 69*/
        if (__Ck5_temp == 70) goto _CKL83; /*case 70*/
        if (__Ck5_temp == 41) goto _CKL84; /*case 41*/
        if (__Ck5_temp == 47) goto _CKL85; /*case 47*/
        if (__Ck5_temp == 48) goto _CKL86; /*case 48*/
        if (__Ck5_temp == 49) goto _CKL87; /*case 49*/
        if (__Ck5_temp == 50) goto _CKL88; /*case 50*/
        if (__Ck5_temp == 53) goto _CKL89; /*case 53*/
        if (__Ck5_temp == 54) goto _CKL90; /*case 54*/
        if (__Ck5_temp == 55) goto _CKL91; /*case 55*/
        if (__Ck5_temp == 56) goto _CKL92; /*case 56*/
        if (__Ck5_temp == 57) goto _CKL93; /*case 57*/
        if (__Ck5_temp == 52) goto _CKL94; /*case 52*/
        if (__Ck5_temp == 51) goto _CKL95; /*case 51*/
        if (__Ck5_temp == 59) goto _CKL96; /*case 59*/
        if (__Ck5_temp == 58) goto _CKL97; /*case 58*/
        if (__Ck5_temp == 26) goto _CKL98; /*case 26*/
        if (__Ck5_temp == 27) goto _CKL99; /*case 27*/
        if (__Ck5_temp == 28) goto _CKL100; /*case 28*/
        if (__Ck5_temp == 72) goto _CKL101; /*case 72*/
        goto _CKL4;

        {
            ...
            _CKL9: /*case 2*/ 
            {
                ...
                if (is_function)
                {
                    is_local_function_definition = p_expression->type.storage_class_specifier_flags & 4096 && p_expression->declarator->function_body != 0U;
                }
            ...
            {
                d_print_type(ctx, oss, &p_expression->type_name->type, 0U);
            }
            ss_fprintf(oss, ", ");
            ...
            _CKL48: /*case 10*/ 
            {
                ...
                struct osstream  lambda_nameless;
                struct declarator * p_current_function_opt;
                ...
                _cake_zmem(&lambda_nameless, 12);
                d_print_type(ctx, &lambda_nameless, &p_expression->type, 0U);
                ;
                ...
                if (l != 0U)
                {
                    snprintf(generated_function_literal_name, 100U, "__Ck%d_f", l->data.number);
                }
                else
                {
                    ...
                    current_cake_declarator_number = ctx->cake_declarator_number++;
                    _cake_zmem(&i, 32);
                    i.number = current_cake_declarator_number;
                    hashmap_set(&ctx->instantiated_function_literals, function_literal.c_str, &i);
                    hash_item_set_destroy(&i);
                    snprintf(generated_function_literal_name, 100U, "__Ck%d_f", current_cake_declarator_number);
            ...
            _CKL50: /*case 11*/ 
            {
                ...
                _cake_zmem(&name, 100);
                snprintf(name, 100U, "__Ck%d_compound_lit", ctx->cake_declarator_number++);
                if (ctx->is_local)
                {
                    struct osstream  local;
...
static void d_visit_init_declarator(struct d_visit_ctx * ctx, struct osstream * oss0, struct init_declarator * p_init_declarator, int function_specifier_flags, int storage_class_specifier_flags)
{
    if (1) /*try*/
    {
        ...
        is_function_body = p_init_declarator->p_declarator->function_body != 0U;
        if (is_typedef)
        {
            return;
        }
                ...
                else
                {
                    ...
                    if (rename_declarator)
                    {
                        if (!p_init_declarator->p_declarator->declarator_renamed)
                        {
                            ...
                            _cake_zmem(&name, 100);
                            snprintf(name, 100U, "__Ck%d_%s", ctx->cake_declarator_number++, p_init_declarator->p_declarator->name_opt->lexeme);
