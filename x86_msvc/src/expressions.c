...
unsigned char is_predefined_constant(struct parser_ctx * ctx)
{
    ...
    return ctx->current->type == 9075 || ctx->current->type == 9076 || ctx->current->type == 9077;
}
...
unsigned char is_first_of_primary_expression(struct parser_ctx * ctx)
{
    ...
    return ctx->current->type == 8996 || is_first_of_constant(ctx) || ctx->current->type == 130 || ctx->current->type == 40 || ctx->current->type == 9068;
}
...
struct generic_assoc_list generic_association_list(struct parser_ctx * ctx, int eval_mode)
{
    ...
    if (1) /*try*/
    {
        ...
        if (p_generic_association->first_token->type == 9008)
        {
        ...
        while (ctx->current->type == 44)
        {
            ...
            if (p_generic_association2->first_token->type == 9008)
            {
...
struct expression *character_constant_expression(struct parser_ctx * ctx)
{
    ...
    if (1) /*try*/
    {
        ...
        p_expression_node = calloc(1, 248U);
        ...
        if (p[0] == 117 && p[1] == 56)
        {
            ...
            p_expression_node->object = object_make_unsigned_char(c);
        }
        else
        {
            if (p[0] == 117)
            {
                ...
                if (*p != 39)
                {
                    compiler_diagnostic(41, ctx, ctx->current, 0U, "Unicode character literals may not contain multiple characters.");
                }
                if (c > target_get_wchar_max(ctx->options.target))
                {
                    compiler_diagnostic(41, ctx, ctx->current, 0U, "Character too large for enclosing character literal type.");
                }
                ...
                else
                {
                    if (p[0] == 76)
                    {
                        ...
                        while (*p != 39)
                        {
                            ...
                            {
                                compiler_diagnostic(42, ctx, ctx->current, 0U, "character constant too long for its type", ctx->current->lexeme);
                                break;
                            }
                        }
...
int convert_to_number(struct parser_ctx * ctx, struct expression * p_expression_node, unsigned char disabled, int target)
{
    ...
    /*switch*/
    {
        register int __Ck0_temp = token->type;
        if (__Ck0_temp == 136) goto _CKL4; /*case 136*/
        if (__Ck0_temp == 137) goto _CKL5; /*case 137*/
        if (__Ck0_temp == 138) goto _CKL6; /*case 138*/
        if (__Ck0_temp == 139) goto _CKL7; /*case 139*/
        if (__Ck0_temp == 140) goto _CKL24; /*case 140*/
        if (__Ck0_temp == 141) goto _CKL25; /*case 141*/
        goto _CKL31;/*default*/

        {
            ...
            _CKL7: /*case 139*/ 
            {
                ...
                /*switch*/
                {
                    register int __Ck1_temp = token->type;
                    if (__Ck1_temp == 136) goto _CKL9; /*case 136*/
                    if (__Ck1_temp == 137) goto _CKL10; /*case 137*/
                    if (__Ck1_temp == 138) goto _CKL12; /*case 138*/
                    if (__Ck1_temp == 139) goto _CKL13; /*case 139*/
                    goto _CKL14;/*default*/
                ...
                if (value == target_get_unsigned_long_long_max(target) && (*_errno()) == 34)
                {
                ...
                {
                    if (value <= target_get_signed_int_max(target) && suffix[0] != 76)
                    {
                        object_destroy(&p_expression_node->object);
                        p_expression_node->object = object_make_signed_int((int)value);
                        p_expression_node->type.type_specifier_flags = 8;
                    ...
                    {
                        if (value <= target_get_signed_int_max(target) && suffix[1] != 76)
                        {
                            object_destroy(&p_expression_node->object);
                        ...
                        {
                            if ((target == 1 || target == 2) && (value <= (unsigned long long)target_get_unsigned_long_max(target)) && suffix[1] != 76)
                            {
                                object_destroy(&p_expression_node->object);
                                p_expression_node->object = object_make_unsigned_long(value, target);
                                p_expression_node->type.type_specifier_flags = 272;
                            ...
                            {
                                if (value <= (unsigned long long)target_get_signed_long_max(target) && suffix[1] != 76)
                                {
                                    object_destroy(&p_expression_node->object);
                                ...
                                {
                                    if (value <= (unsigned long long)target_get_signed_long_long_max(target))
                                    {
                                        object_destroy(&p_expression_node->object);
                                    ...
                                    {
                                        compiler_diagnostic(50, ctx, token, 0U, "integer literal is too large to be represented in a signed integer type, interpreting as unsigned");
                                        object_destroy(&p_expression_node->object);
                                        p_expression_node->object = object_make_unsigned_long_long(value);
                                        p_expression_node->type.type_specifier_flags = 4194560;
                                    }
    ...
    if (1) /*try*/
    {
        if (ctx->current->type == 8996)
        {
            ...
            else
            {
                if (p_entry && (p_entry->type == 4 || p_entry->type == 5))
                {
                    ...
                    {
                        compiler_diagnostic(3, ctx, ctx->current, 0U, "'%s' is deprecated", ctx->current->lexeme);
                    }
                ...
                else
                {
                    if (ctx->p_current_function_opt && strcmp(ctx->current->lexeme, "__func__") == 0)
                    {
                        ...
                        p_expression_node->first_token = ctx->current;
                        p_expression_node->last_token = ctx->current;
                        p_expression_node->type = type_make_literal_string(strlen(func_name) + 1, 2, 1, ctx->options.target);
                    }
                    else
                    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    if (ctx->current->type == 9075 || ctx->current->type == 9076)
                    {
                        p_expression_node = calloc(1, 248U);
                        if (p_expression_node == 0U)
                        {
                        ...
                        p_expression_node->first_token = ctx->current;
                        p_expression_node->last_token = ctx->current;
                        p_expression_node->object = object_make_bool(ctx->current->type == 9075);
    ...
    if (1) /*try*/
    {
        while (ctx->current != 0U)
        {
            if (ctx->current->type == 91)
            {
                ...
                p_expression_node_new = calloc(1, 248U);
                ...
                if (object_has_constant_value(&p_expression_node_new->right->object))
                {
                    ...
                    if (type_is_array(&p_expression_node->type))
                    {
                        if (p_expression_node->type.num_of_elements > 0)
                        {
                            ...
                            {
                                compiler_diagnostic(42, ctx, ctx->current, 0U, "index %d is past the end of the array", index);
                            }
                    ...
                    else
                    {
                        if (ctx->current->type == 11582)
                        {
                            ...
                            if (type_is_pointer_or_array(&p_expression_node->type))
                            {
                                ...
                                if (type_is_array(&p_expression_node->type))
                                {
                                    compiler_diagnostic(20, ctx, ctx->current, 0U, "using indirection '->' in array");
...
unsigned char is_first_of_compiler_function(struct parser_ctx * ctx)
{
    ...
    return ctx->current->type == 9090 || ctx->current->type == 9092 || ctx->current->type == 9091 || ctx->current->type == 9089 || ctx->current->type == 9093 || ctx->current->type == 9094 || ctx->current->type == 9072 || ctx->current->type == 9095 || ctx->current->type == 9096 || ctx->current->type == 9097 || ctx->current->type == 9098;
}
...
unsigned char is_first_of_unary_expression(struct parser_ctx * ctx)
{
    ...
    return first_of_postfix_expression(ctx) || ctx->current->type == 11051 || ctx->current->type == 11565 || ctx->current->type == 38 || ctx->current->type == 42 || ctx->current->type == 43 || ctx->current->type == 45 || ctx->current->type == 126 || ctx->current->type == 33 || ctx->current->type == 9031 || ctx->current->type == 9032 || ctx->current->type == 9045 || ctx->current->type == 9049 || ctx->current->type == 9050 || ctx->current->type == 9051 || ctx->current->type == 9052 || ctx->current->type == 9053 || is_first_of_compiler_function(ctx);
}
                ...
                else
                {
                    if (op == 126)
                    {
                        ...
                        if (eval_mode == 2 && object_has_constant_value(&new_expression->right->object))
                        {
                            ...
                            vt = type_to_object_type(&new_expression->type, ctx->options.target);
                            /*switch*/
                            {
                                register int __Ck2_temp = vt;
                                if (__Ck2_temp == 4) goto _CKL17; /*case 4*/
                                if (__Ck2_temp == 5) goto _CKL18; /*case 5*/
                                if (__Ck2_temp == 6) goto _CKL19; /*case 6*/
                                if (__Ck2_temp == 7) goto _CKL20; /*case 7*/
                                if (__Ck2_temp == 2) goto _CKL21; /*case 2*/
                                if (__Ck2_temp == 3) goto _CKL22; /*case 3*/
                                if (__Ck2_temp == 0) goto _CKL23; /*case 0*/
                                if (__Ck2_temp == 1) goto _CKL24; /*case 1*/
                                if (__Ck2_temp == 8) goto _CKL25; /*case 8*/
                                if (__Ck2_temp == 9) goto _CKL26; /*case 9*/
                                goto _CKL16;
                    ...
                    else
                    {
                        if (op == 45 || op == 43)
                        {
                            ...
                            if (eval_mode == 2 && object_has_constant_value(&new_expression->right->object))
                            {
                                ...
                                /*switch*/
                                {
                                    register int __Ck3_temp = vt;
                                    if (__Ck3_temp == 4) goto _CKL31; /*case 4*/
                                    if (__Ck3_temp == 5) goto _CKL33; /*case 5*/
                                    if (__Ck3_temp == 6) goto _CKL35; /*case 6*/
                                    if (__Ck3_temp == 7) goto _CKL37; /*case 7*/
                                    if (__Ck3_temp == 0) goto _CKL39; /*case 0*/
                                    if (__Ck3_temp == 1) goto _CKL40; /*case 1*/
                                    if (__Ck3_temp == 2) goto _CKL41; /*case 2*/
                                    if (__Ck3_temp == 3) goto _CKL42; /*case 3*/
                                    if (__Ck3_temp == 8) goto _CKL43; /*case 8*/
                                    if (__Ck3_temp == 9) goto _CKL45; /*case 9*/
                                    goto _CKL30;
                        ...
                        else
                        {
                            if (op == 42)
                            {
                                ...
                                {
                                    compiler_diagnostic(20, ctx, op_position, 0U, "array indirection");
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        if (ctx->current->type == 9090 || ctx->current->type == 9092 || ctx->current->type == 9091 || ctx->current->type == 9089 || ctx->current->type == 9093 || ctx->current->type == 9094 || ctx->current->type == 9096 || ctx->current->type == 9095 || ctx->current->type == 9097 || ctx->current->type == 9098)
                                                        {
                                                            ...
                                                            /*switch*/
                                                            {
                                                                register int __Ck4_temp = traits_token->type;
                                                                if (__Ck4_temp == 9090) goto _CKL161; /*case 9090*/
                                                                if (__Ck4_temp == 9091) goto _CKL162; /*case 9091*/
                                                                if (__Ck4_temp == 9092) goto _CKL163; /*case 9092*/
                                                                if (__Ck4_temp == 9089) goto _CKL164; /*case 9089*/
                                                                if (__Ck4_temp == 9094) goto _CKL165; /*case 9094*/
                                                                if (__Ck4_temp == 9093) goto _CKL166; /*case 9093*/
                                                                if (__Ck4_temp == 9096) goto _CKL167; /*case 9096*/
                                                                if (__Ck4_temp == 9095) goto _CKL168; /*case 9095*/
                                                                if (__Ck4_temp == 9097) goto _CKL169; /*case 9097*/
                                                                if (__Ck4_temp == 9098) goto _CKL170; /*case 9098*/
                                                                goto _CKL171;/*default*/
    ...
    else
    {
        ...
        else
        {
            if (category == 2)
            {
                ...
                {
                    compiler_diagnostic(47, ctx, p_expression->first_token, 0U, "sizeof applied to array function parameter");
                }
            }
        }
    }
                ...
                if (is_first_of_unary_expression(ctx))
                {
                    ...
                    if (p_expression_node->left->type.storage_class_specifier_flags & 8192 && type_is_owner(&p_expression_node->left->type))
                    {
                        if (!type_is_owner(&p_expression_node->type))
                        {
                            ...
                            {
                                compiler_diagnostic(26, ctx, p_expression_node->first_token, 0U, "discarding _Owner pointer");
                            }
                            else
                            {
                                compiler_diagnostic(26, ctx, p_expression_node->first_token, 0U, "discarding _Owner");
                            }
                        }
                    }
...
int execute_arithmetic(struct parser_ctx * ctx, struct expression * new_expression, int op, struct object * result)
{
    ...
    if (1) /*try*/
    {
        ...
        _cake_zmem(&value, 112);
        /*switch*/
        {
            register int __Ck5_temp = op;
            if (__Ck5_temp == 43) goto _CKL3; /*case 43*/
            if (__Ck5_temp == 45) goto _CKL4; /*case 45*/
            if (__Ck5_temp == 42) goto _CKL5; /*case 42*/
            if (__Ck5_temp == 47) goto _CKL6; /*case 47*/
            if (__Ck5_temp == 37) goto _CKL7; /*case 37*/
            if (__Ck5_temp == 62) goto _CKL8; /*case 62*/
            if (__Ck5_temp == 60) goto _CKL9; /*case 60*/
            if (__Ck5_temp == 15933) goto _CKL10; /*case 15933*/
            if (__Ck5_temp == 15421) goto _CKL11; /*case 15421*/
            if (__Ck5_temp == 15677) goto _CKL12; /*case 15677*/
            if (__Ck5_temp == 8509) goto _CKL13; /*case 8509*/
            goto _CKL14;/*default*/
        ...
        if (object_has_constant_value(&new_expression->left->object) && object_has_constant_value(&new_expression->right->object))
        {
            ...
            vt = type_to_object_type(&common_type, ctx->options.target);
            /*switch*/
            {
                register int __Ck6_temp = vt;
                if (__Ck6_temp == 4) goto _CKL19; /*case 4*/
                if (__Ck6_temp == 5) goto _CKL40; /*case 5*/
                if (__Ck6_temp == 6) goto _CKL60; /*case 6*/
                if (__Ck6_temp == 7) goto _CKL78; /*case 7*/
                if (__Ck6_temp == 0) goto _CKL95; /*case 0*/
                if (__Ck6_temp == 1) goto _CKL96; /*case 1*/
                if (__Ck6_temp == 2) goto _CKL97; /*case 2*/
                if (__Ck6_temp == 3) goto _CKL98; /*case 3*/
                if (__Ck6_temp == 8) goto _CKL99; /*case 8*/
                if (__Ck6_temp == 9) goto _CKL112; /*case 9*/
                goto _CKL18;

                {
                    _CKL19: /*case 4*/ 
                    {
                        ...
                        if (op == 43)
                        {
                            ...
                            if (signed_long_long_add(&exact_result, a, b))
                            {
                                ...
                                {
                                    compiler_diagnostic(51, ctx, 0U, &m, "integer overflow results in '%d'. Exactly result is '%lld'.", computed_result, exact_result);
                                }
                            }
                            else
                            {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    if (op == 47)
                                    {
                                        if (b == 0)
                                        {
                                            compiler_diagnostic(37, ctx, new_expression->right->first_token, 0U, "division by zero");
                                        }
                                        else
                                        {
                                            if (a == -2147483648 && b == -1)
                                            {
                                                compiler_diagnostic(51, ctx, new_expression->right->first_token, 0U, "integer overflow");
                    ...
                    _CKL60: /*case 6*/ 
                    {
                        ...
                        if (op == 43)
                        {
                            ...
                            if (!signed_long_long_add(&exact_result, a, b))
                            {
                                compiler_diagnostic(51, ctx, 0U, &m, "integer overflow results in '%dll'. ", computed_result);
                            }
                    ...
                    _CKL78: /*case 7*/ 
                    {
                        ...
                        if (op == 43)
                        {
                            ...
                            {
                                compiler_diagnostic(51, ctx, 0U, &m, "integer overflow");
                            }
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        if (op == 37)
                                        {
                                            compiler_diagnostic(37, ctx, new_expression->right->first_token, 0U, "'%': not valid as left operand has type 'float'");
                                            goto _CKL0;/*throw*/
                                        }
                                        else
                                        {
...
struct expression *multiplicative_expression(struct parser_ctx * ctx, int eval_mode)
{
    ...
    if (1) /*try*/
    {
        ...
        while (ctx->current != 0U && (ctx->current->type == 42 || ctx->current->type == 47 || ctx->current->type == 37))
        {
            ...
            /*switch*/
            {
                register int __Ck7_temp = op;
                if (__Ck7_temp == 42) goto _CKL5; /*case 42*/
                if (__Ck7_temp == 47) goto _CKL6; /*case 47*/
                if (__Ck7_temp == 37) goto _CKL7; /*case 37*/
                goto _CKL8;/*default*/
...
static int execute_bitwise_operator(struct parser_ctx * ctx, struct expression * new_expression, int op)
{
    if (1) /*try*/
    {
        /*switch*/
        {
            register int __Ck8_temp = op;
            if (__Ck8_temp == 38) goto _CKL2; /*case 38*/
            if (__Ck8_temp == 94) goto _CKL3; /*case 94*/
            if (__Ck8_temp == 124) goto _CKL4; /*case 124*/
            if (__Ck8_temp == 15934) goto _CKL5; /*case 15934*/
            if (__Ck8_temp == 15420) goto _CKL6; /*case 15420*/
            goto _CKL7;/*default*/
        ...
        if (object_has_constant_value(&new_expression->left->object) && object_has_constant_value(&new_expression->right->object))
        {
            ...
            /*switch*/
            {
                register int __Ck9_temp = vt;
                if (__Ck9_temp == 4) goto _CKL12; /*case 4*/
                if (__Ck9_temp == 5) goto _CKL18; /*case 5*/
                if (__Ck9_temp == 6) goto _CKL24; /*case 6*/
                if (__Ck9_temp == 7) goto _CKL30; /*case 7*/
                if (__Ck9_temp == 0) goto _CKL36; /*case 0*/
                if (__Ck9_temp == 1) goto _CKL37; /*case 1*/
                if (__Ck9_temp == 2) goto _CKL38; /*case 2*/
                if (__Ck9_temp == 3) goto _CKL39; /*case 3*/
                if (__Ck9_temp == 8) goto _CKL40; /*case 8*/
                if (__Ck9_temp == 9) goto _CKL41; /*case 9*/
                goto _CKL11;
...
static unsigned long long __Ck10__OptionsStorage;
...
void check_diferent_enuns(struct parser_ctx * ctx, struct token * operator_token, struct expression * left, struct expression * right, char * message)
{
    if (left->type.type_specifier_flags & 65536 && right->type.type_specifier_flags & 65536)
    {
        ...
        if (get_complete_enum_specifier(left->type.enum_specifier) != get_complete_enum_specifier(right->type.enum_specifier))
        {
            ...
            compiler_diagnostic(4, ctx, operator_token, 0U, finalmessage, lefttag, righttag);
        }
    }
}
...
struct expression *logical_or_expression(struct parser_ctx * ctx, int eval_mode)
{
    ...
    if (1) /*try*/
    {
        ...
        while (ctx->current != 0U && (ctx->current->type == 31868))
        {
            ...
            /*switch*/
            {
                register int __Ck11_temp = current_eval_mode;
                if (__Ck11_temp == 0) goto _CKL7; /*case 0*/
                if (__Ck11_temp == 1) goto _CKL8; /*case 1*/
                if (__Ck11_temp == 2) goto _CKL9; /*case 2*/
                goto _CKL6;
...
struct expression *assignment_expression(struct parser_ctx * ctx, int eval_mode)
{
    ...
    if (1) /*try*/
    {
        ...
        while (ctx->current != 0U && (ctx->current->type == 61 || ctx->current->type == 10813 || ctx->current->type == 12093 || ctx->current->type == 9533 || ctx->current->type == 11069 || ctx->current->type == 11581 || ctx->current->type == 3947581 || ctx->current->type == 4079165 || ctx->current->type == 9789 || ctx->current->type == 24125 || ctx->current->type == 31805))
        {
            ...
            /*switch*/
            {
                register int __Ck12_temp = op_token->type;
                if (__Ck12_temp == 61) goto _CKL5; /*case 61*/
                if (__Ck12_temp == 10813) goto _CKL6; /*case 10813*/
                if (__Ck12_temp == 12093) goto _CKL7; /*case 12093*/
                if (__Ck12_temp == 9533) goto _CKL8; /*case 9533*/
                if (__Ck12_temp == 11069) goto _CKL9; /*case 11069*/
                if (__Ck12_temp == 11581) goto _CKL10; /*case 11581*/
                if (__Ck12_temp == 3947581) goto _CKL11; /*case 3947581*/
                if (__Ck12_temp == 4079165) goto _CKL12; /*case 4079165*/
                if (__Ck12_temp == 9789) goto _CKL13; /*case 9789*/
                if (__Ck12_temp == 24125) goto _CKL14; /*case 24125*/
                if (__Ck12_temp == 31805) goto _CKL15; /*case 31805*/
                goto _CKL16;/*default*/
            ...
            else
            {
                if (type_is_array(&new_expression->left->type))
                {
                    ...
                    {
                        compiler_diagnostic(43, ctx, 0U, &left_operand_marker, "assignment to array parameter");
                    }
                    else
                    {
...
struct expression *conditional_expression(struct parser_ctx * ctx, int eval_mode)
{
    ...
    if (1) /*try*/
    {
        ...
        if (ctx->current && ctx->current->type == 63)
        {
            ...
            p_conditional_expression = calloc(1, 248U);
            ...
            /*switch*/
            {
                register int __Ck13_temp = current_eval_mode;
                if (__Ck13_temp == 0) goto _CKL8; /*case 0*/
                if (__Ck13_temp == 1) goto _CKL9; /*case 1*/
                if (__Ck13_temp == 2) goto _CKL10; /*case 2*/
                goto _CKL7;
            ...
            /*switch*/
            {
                register int __Ck14_temp = eval_mode;
                if (__Ck14_temp == 0) goto _CKL15; /*case 0*/
                if (__Ck14_temp == 1) goto _CKL16; /*case 1*/
                if (__Ck14_temp == 2) goto _CKL17; /*case 2*/
                goto _CKL14;
...
unsigned char expression_get_variables(struct expression * expr, int n, struct object *variables[])
{
    ...
    /*switch*/
    {
        register int __Ck15_temp = expr->expression_type;
        if (__Ck15_temp == 0) goto _CKL1; /*case 0*/
        if (__Ck15_temp == 1) goto _CKL2; /*case 1*/
        if (__Ck15_temp == 2) goto _CKL3; /*case 2*/
        if (__Ck15_temp == 3) goto _CKL6; /*case 3*/
        if (__Ck15_temp == 4) goto _CKL7; /*case 4*/
        if (__Ck15_temp == 5) goto _CKL8; /*case 5*/
        if (__Ck15_temp == 6) goto _CKL9; /*case 6*/
        if (__Ck15_temp == 7) goto _CKL10; /*case 7*/
        if (__Ck15_temp == 8) goto _CKL11; /*case 8*/
        if (__Ck15_temp == 9) goto _CKL12; /*case 9*/
        if (__Ck15_temp == 10) goto _CKL13; /*case 10*/
        if (__Ck15_temp == 11) goto _CKL14; /*case 11*/
        if (__Ck15_temp == 12) goto _CKL15; /*case 12*/
        if (__Ck15_temp == 13) goto _CKL16; /*case 13*/
        if (__Ck15_temp == 14) goto _CKL17; /*case 14*/
        if (__Ck15_temp == 15) goto _CKL18; /*case 15*/
        if (__Ck15_temp == 16) goto _CKL19; /*case 16*/
        if (__Ck15_temp == 17) goto _CKL20; /*case 17*/
        if (__Ck15_temp == 18) goto _CKL21; /*case 18*/
        if (__Ck15_temp == 19) goto _CKL22; /*case 19*/
        if (__Ck15_temp == 20) goto _CKL23; /*case 20*/
        if (__Ck15_temp == 26) goto _CKL24; /*case 26*/
        if (__Ck15_temp == 27) goto _CKL25; /*case 27*/
        if (__Ck15_temp == 28) goto _CKL26; /*case 28*/
        if (__Ck15_temp == 29) goto _CKL27; /*case 29*/
        if (__Ck15_temp == 30) goto _CKL28; /*case 30*/
        if (__Ck15_temp == 31) goto _CKL29; /*case 31*/
        if (__Ck15_temp == 33) goto _CKL30; /*case 33*/
        if (__Ck15_temp == 34) goto _CKL31; /*case 34*/
        if (__Ck15_temp == 35) goto _CKL32; /*case 35*/
        if (__Ck15_temp == 36) goto _CKL33; /*case 36*/
        if (__Ck15_temp == 37) goto _CKL34; /*case 37*/
        if (__Ck15_temp == 38) goto _CKL35; /*case 38*/
        if (__Ck15_temp == 39) goto _CKL36; /*case 39*/
        if (__Ck15_temp == 40) goto _CKL37; /*case 40*/
        if (__Ck15_temp == 41) goto _CKL38; /*case 41*/
        if (__Ck15_temp == 42) goto _CKL39; /*case 42*/
        if (__Ck15_temp == 43) goto _CKL40; /*case 43*/
        if (__Ck15_temp == 44) goto _CKL41; /*case 44*/
        if (__Ck15_temp == 45) goto _CKL42; /*case 45*/
        if (__Ck15_temp == 46) goto _CKL43; /*case 46*/
        if (__Ck15_temp == 47) goto _CKL44; /*case 47*/
        if (__Ck15_temp == 48) goto _CKL45; /*case 48*/
        if (__Ck15_temp == 49) goto _CKL46; /*case 49*/
        if (__Ck15_temp == 50) goto _CKL47; /*case 50*/
        if (__Ck15_temp == 51) goto _CKL48; /*case 51*/
        if (__Ck15_temp == 52) goto _CKL49; /*case 52*/
        if (__Ck15_temp == 53) goto _CKL50; /*case 53*/
        if (__Ck15_temp == 54) goto _CKL51; /*case 54*/
        if (__Ck15_temp == 55) goto _CKL52; /*case 55*/
        if (__Ck15_temp == 56) goto _CKL53; /*case 56*/
        if (__Ck15_temp == 57) goto _CKL54; /*case 57*/
        if (__Ck15_temp == 58) goto _CKL55; /*case 58*/
        if (__Ck15_temp == 59) goto _CKL56; /*case 59*/
        if (__Ck15_temp == 60) goto _CKL57; /*case 60*/
        if (__Ck15_temp == 61) goto _CKL58; /*case 61*/
        if (__Ck15_temp == 62) goto _CKL59; /*case 62*/
        if (__Ck15_temp == 63) goto _CKL60; /*case 63*/
        if (__Ck15_temp == 64) goto _CKL61; /*case 64*/
        if (__Ck15_temp == 65) goto _CKL62; /*case 65*/
        if (__Ck15_temp == 66) goto _CKL63; /*case 66*/
        if (__Ck15_temp == 67) goto _CKL64; /*case 67*/
        if (__Ck15_temp == 68) goto _CKL65; /*case 68*/
        if (__Ck15_temp == 69) goto _CKL66; /*case 69*/
        if (__Ck15_temp == 70) goto _CKL67; /*case 70*/
        if (__Ck15_temp == 71) goto _CKL68; /*case 71*/
        if (__Ck15_temp == 72) goto _CKL69; /*case 72*/
        if (__Ck15_temp == 21) goto _CKL70; /*case 21*/
        if (__Ck15_temp == 22) goto _CKL71; /*case 22*/
        if (__Ck15_temp == 23) goto _CKL72; /*case 23*/
        if (__Ck15_temp == 24) goto _CKL73; /*case 24*/
        if (__Ck15_temp == 25) goto _CKL74; /*case 25*/
        if (__Ck15_temp == 32) goto _CKL75; /*case 32*/
        goto _CKL0;
...
unsigned char expression_is_lvalue(struct expression * expr)
{
    /*switch*/
    {
        register int __Ck16_temp = expr->expression_type;
        if (__Ck16_temp == 2) goto _CKL1; /*case 2*/
        if (__Ck16_temp == 4) goto _CKL2; /*case 4*/
        if (__Ck16_temp == 3) goto _CKL3; /*case 3*/
        if (__Ck16_temp == 13) goto _CKL4; /*case 13*/
        if (__Ck16_temp == 15) goto _CKL5; /*case 15*/
        if (__Ck16_temp == 11) goto _CKL6; /*case 11*/
        if (__Ck16_temp == 39) goto _CKL7; /*case 39*/
        goto _CKL8;/*default*/
...
unsigned char expression_is_subjected_to_lvalue_conversion(struct expression * expression)
{
    /*switch*/
    {
        register int __Ck17_temp = expression->expression_type;
        if (__Ck17_temp == 40) goto _CKL1; /*case 40*/
        if (__Ck17_temp == 33) goto _CKL2; /*case 33*/
        if (__Ck17_temp == 34) goto _CKL3; /*case 34*/
        if (__Ck17_temp == 16) goto _CKL4; /*case 16*/
        if (__Ck17_temp == 17) goto _CKL5; /*case 17*/
        goto _CKL6;/*default*/
...
void check_comparison(struct parser_ctx * ctx, struct expression * p_a_expression, struct expression * p_b_expression, struct token * op_token)
{
    ...
    if (type_is_pointer(p_a_type) && type_is_integer(p_b_type))
    {
        ...
        {
            compiler_diagnostic(4, ctx, op_token, 0U, "comparison between pointer and integer");
        }
    }
    if (type_is_bool(p_a_type) && !(type_is_bool(p_b_type) || type_is_essential_bool(p_b_type)))
    {
        ...
        {
            compiler_diagnostic(58, ctx, op_token, 0U, "comparison bool with non bool");
        }
    }
...
void check_assigment(struct parser_ctx * ctx, struct type * p_a_type, struct expression * p_b_expression, int assignment_type)
{
    ...
    if (type_is_pointer(p_a_type))
    {
        if (!type_is_nullptr_t(p_b_type) && !type_is_pointer_or_array(p_b_type) && !type_is_function(p_b_type))
        {
            if (is_null_pointer_constant)
            {
                ...
                {
                    compiler_diagnostic(11, ctx, p_b_expression->first_token, 0U, "use NULL instead of 0");
                }
                else
                {
                    compiler_diagnostic(46, ctx, p_b_expression->first_token, 0U, "unusual expression/type used as null pointer constant");
                }
            }
            else
            {
    ...
    if (type_is_bool(p_a_type) && type_is_nullptr_t(p_b_type))
    {
        ...
        compiler_diagnostic(49, ctx, 0U, &marker, "implicit conversion of nullptr constant to 'bool'");
    }
    ...
    if (type_is_owner(p_a_type) && !type_is_owner(&p_b_expression->type))
    {
        if (!is_null_pointer_constant)
        {
            compiler_diagnostic(25, ctx, p_b_expression->first_token, 0U, "cannot assign a non-owner to owner");
    ...
    if (!type_is_owner(p_a_type) && type_is_owner_or_pointer_to_dtor(&p_b_expression->type))
    {
        ...
        {
            compiler_diagnostic(23, ctx, p_b_expression->first_token, 0U, "cannot assign a temporary owner to non-owner object.");
            type_destroy(&b_type_lvalue);
            return;
        }
    }
    ...
    if (type_is_pointed_dtor(p_a_type) && type_is_pointer(p_a_type))
    {
        ...
        else
        {
            ...
            {
                compiler_diagnostic(19, ctx, p_b_expression->first_token, 0U, "source expression of _Dtor must be addressof");
            }
        }
    }
    if (type_is_pointer(p_a_type) && !type_is_opt(p_a_type, ctx->options.null_checks_enabled) && is_null_pointer_constant)
    {
        compiler_diagnostic(60, ctx, p_b_expression->first_token, 0U, "cannot convert a null pointer constant to non-nullable pointer");
        type_destroy(&b_type_lvalue);
        return;
    }
    if (type_is_enum(p_b_type) && type_is_enum(p_a_type))
    {
        ...
        {
            compiler_diagnostic(40, ctx, p_b_expression->first_token, 0U, " incompatible types ");
        }
        type_destroy(&b_type_lvalue);
        return;
    }
    ...
    {
        compiler_diagnostic(39, ctx, p_b_expression->first_token, 0U, " passing null as array");
        type_destroy(&b_type_lvalue);
        return;
    }
    if (type_is_pointer_or_array(p_b_type) && type_is_pointer_or_array(p_a_type))
    {
        ...
        if (!type_is_same(&b_type_lvalue, &a_type_lvalue, 0))
        {
            ...
            compiler_diagnostic(54, ctx, p_b_expression->first_token, 0U, " incompatible types");
        }
        if (assignment_type == 1)
        {
            if (type_is_pointer(&b_type_lvalue) && type_is_pointer(&a_type_lvalue))
            {
                ...
                {
                    compiler_diagnostic(15, ctx, p_b_expression->first_token, 0U, " discarding const at argument ");
                }
        ...
        else
        {
            if (type_is_pointer(p_a_type) && type_is_pointer(&b_type_lvalue))
            {
                ...
                {
                    compiler_diagnostic(15, ctx, p_b_expression->first_token, 0U, " discarding const");
                }
...
struct object expression_eval(struct expression * p_expression)
{
    ...
    _cake_zmem(&result, 112);
    /*switch*/
    {
        register int __Ck18_temp = p_expression->expression_type;
        ...
        if (__Ck18_temp == 5) goto _CKL6; /*case 5*/
        if (__Ck18_temp == 6) goto _CKL7; /*case 6*/
        if (__Ck18_temp == 7) goto _CKL8; /*case 7*/
        if (__Ck18_temp == 8) goto _CKL9; /*case 8*/
        if (__Ck18_temp == 9) goto _CKL10; /*case 9*/
        if (__Ck18_temp == 10) goto _CKL11; /*case 10*/
        if (__Ck18_temp == 11) goto _CKL12; /*case 11*/
        if (__Ck18_temp == 12) goto _CKL13; /*case 12*/
        if (__Ck18_temp == 13) goto _CKL14; /*case 13*/
        if (__Ck18_temp == 14) goto _CKL15; /*case 14*/
        if (__Ck18_temp == 15) goto _CKL16; /*case 15*/
        if (__Ck18_temp == 16) goto _CKL17; /*case 16*/
        if (__Ck18_temp == 17) goto _CKL18; /*case 17*/
        if (__Ck18_temp == 18) goto _CKL19; /*case 18*/
        if (__Ck18_temp == 19) goto _CKL20; /*case 19*/
        if (__Ck18_temp == 20) goto _CKL21; /*case 20*/
        if (__Ck18_temp == 26) goto _CKL22; /*case 26*/
        if (__Ck18_temp == 27) goto _CKL23; /*case 27*/
        if (__Ck18_temp == 28) goto _CKL24; /*case 28*/
        if (__Ck18_temp == 29) goto _CKL25; /*case 29*/
        if (__Ck18_temp == 30) goto _CKL26; /*case 30*/
        if (__Ck18_temp == 31) goto _CKL27; /*case 31*/
        if (__Ck18_temp == 33) goto _CKL28; /*case 33*/
        if (__Ck18_temp == 34) goto _CKL29; /*case 34*/
        if (__Ck18_temp == 35) goto _CKL30; /*case 35*/
        if (__Ck18_temp == 36) goto _CKL31; /*case 36*/
        if (__Ck18_temp == 37) goto _CKL32; /*case 37*/
        if (__Ck18_temp == 38) goto _CKL33; /*case 38*/
        if (__Ck18_temp == 39) goto _CKL34; /*case 39*/
        if (__Ck18_temp == 40) goto _CKL35; /*case 40*/
        if (__Ck18_temp == 41) goto _CKL36; /*case 41*/
        if (__Ck18_temp == 42) goto _CKL37; /*case 42*/
        if (__Ck18_temp == 43) goto _CKL38; /*case 43*/
        if (__Ck18_temp == 44) goto _CKL39; /*case 44*/
        if (__Ck18_temp == 45) goto _CKL40; /*case 45*/
        if (__Ck18_temp == 46) goto _CKL43; /*case 46*/
        if (__Ck18_temp == 47) goto _CKL46; /*case 47*/
        if (__Ck18_temp == 48) goto _CKL47; /*case 48*/
        if (__Ck18_temp == 49) goto _CKL48; /*case 49*/
        if (__Ck18_temp == 50) goto _CKL49; /*case 50*/
        if (__Ck18_temp == 51) goto _CKL50; /*case 51*/
        if (__Ck18_temp == 52) goto _CKL51; /*case 52*/
        if (__Ck18_temp == 53) goto _CKL52; /*case 53*/
        if (__Ck18_temp == 54) goto _CKL54; /*case 54*/
        if (__Ck18_temp == 55) goto _CKL56; /*case 55*/
        if (__Ck18_temp == 56) goto _CKL57; /*case 56*/
        if (__Ck18_temp == 57) goto _CKL58; /*case 57*/
        if (__Ck18_temp == 58) goto _CKL59; /*case 58*/
        if (__Ck18_temp == 59) goto _CKL64; /*case 59*/
        if (__Ck18_temp == 60) goto _CKL65; /*case 60*/
        if (__Ck18_temp == 61) goto _CKL66; /*case 61*/
        if (__Ck18_temp == 62) goto _CKL67; /*case 62*/
        if (__Ck18_temp == 63) goto _CKL68; /*case 63*/
        if (__Ck18_temp == 64) goto _CKL69; /*case 64*/
        if (__Ck18_temp == 65) goto _CKL70; /*case 65*/
        if (__Ck18_temp == 66) goto _CKL71; /*case 66*/
        if (__Ck18_temp == 67) goto _CKL72; /*case 67*/
        if (__Ck18_temp == 68) goto _CKL73; /*case 68*/
        if (__Ck18_temp == 69) goto _CKL74; /*case 69*/
        if (__Ck18_temp == 70) goto _CKL75; /*case 70*/
        if (__Ck18_temp == 71) goto _CKL76; /*case 71*/
        if (__Ck18_temp == 72) goto _CKL77; /*case 72*/
        if (__Ck18_temp == 21) goto _CKL78; /*case 21*/
        if (__Ck18_temp == 22) goto _CKL79; /*case 22*/
        if (__Ck18_temp == 23) goto _CKL80; /*case 23*/
        if (__Ck18_temp == 24) goto _CKL81; /*case 24*/
        if (__Ck18_temp == 25) goto _CKL82; /*case 25*/
        if (__Ck18_temp == 32) goto _CKL83; /*case 32*/
        goto _CKL0;
