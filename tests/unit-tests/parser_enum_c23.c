...
static_assert(_Generic(_0, int:1, default:0));
static_assert(_Generic(_256, int:1, default:0));
static_assert(_0 == -1 &&_256 == 255);
static_assert(_Generic(enum A, int:1, default:0));
...
static_assert(_Generic(enum B, unsigned: 1, default: 0));
