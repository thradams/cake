...
int __cdecl __stdio_common_vswscanf(unsigned long long _Options, unsigned short * _Buffer, unsigned long long _BufferCount, unsigned short * _Format, struct __crt_locale_pointers * _Locale, char * _ArgList);
...
static int __cdecl _vswscanf_l(unsigned short * _Buffer, unsigned short * _Format, struct __crt_locale_pointers * _Locale, char * _ArgList)
{
    return __stdio_common_vswscanf((*__local_stdio_scanf_options()), _Buffer, 18446744073709551615ULL, _Format, _Locale, _ArgList);
}
