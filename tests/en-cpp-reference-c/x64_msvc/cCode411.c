...
static void _cake_memcpy(void * dest, const void * src, unsigned long long n)
{
  char *csrc;
  char *cdest;
...
static unsigned short *__cdecl wmemcpy(unsigned short * _S1, unsigned short * _S2, unsigned long long _N);
...
static unsigned short *__cdecl wmemcpy(unsigned short * _S1, unsigned short * _S2, unsigned long long _N)
{
    return (unsigned short *)memcpy(_S1, _S2, _N * 2ULL);
}
