...
unsigned short *__cdecl wcspbrk(unsigned short * _String, unsigned short * _Control);
unsigned long long __cdecl wcsspn(unsigned short * _String, unsigned short * _Control);
