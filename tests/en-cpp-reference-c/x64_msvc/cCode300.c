...
struct _SETJMP_FLOAT128 my_jump_buffer[16];
...
void __cdecl longjmp(struct _SETJMP_FLOAT128 _Buf[16], int _Value);
...
int __cdecl _setjmp(struct _SETJMP_FLOAT128 _Buf[16]);
