...
void bug_test(void);
void test_rescan_does_not_invoke_passed_over_macro(void);
void test_rescan_completes_last_token_with_source(void);
void test_c11_6_10_3_5_example_3(void);
...
g_unit_test_success_count = 0;
    ...
    test_counter();
    bug_test();
    test_rescan_does_not_invoke_passed_over_macro();
    test_rescan_completes_last_token_with_source();
    test_c11_6_10_3_5_example_3();
