...
void tag_scope1(void);
void tag_scope2(void);
void tag_scope3(void);
...
void return_address_of_local2(void);
...
void flow_analyzes_and_try_catch(void);
...
void value_of_constant_char(void);
void enum_type(void);
