...
struct flow_object_state2;

struct flow_object_state_list {

    struct flow_object_state2* head;
    struct flow_object_state2* tail;

};

enum flow_object_meaning {
    
    FLOW_OBJECT_MEANING_EQUAL,  //object == value 
    FLOW_OBJECT_MEANING_NOT_EQUAL, //object != value 
    FLOW_OBJECT_MEANING_UNINITIALIZED,   //value? 
    FLOW_OBJECT_MEANING_UNKNOWN,   //value? 
    FLOW_OBJECT_MEANING_REFERENCE, //value is the id of the object we point to 
};
...
struct flow_object_state2
{
    ...
    enum flow_object_meaning meaning;
    struct object value;
    struct flow_object_state2* next;
};
...
struct flow_object
{
    ...
    struct flow_object_state_list states;
...
struct flow_visit_ctx
{
    ...
    struct int_array current_states; //II
